...
from r34_client.ui.rendering.preview_fetcher import fetch_preview_bytes, preview_candidate_urls
...
class PreviewFetcherTests(unittest.TestCase):
    ...
    def test_fetch_preview_bytes_retries_after_403(self) -> None:
        ...
        with patch("r34_client.ui.rendering.preview_fetcher.requests.get", side_effect=fake_get):
